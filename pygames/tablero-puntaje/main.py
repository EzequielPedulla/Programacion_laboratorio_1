...
img_fondo = pygame.image.load(
    r'pygames\tablero-puntaje\recursos\img\fondo.png')

# Cargamos la imagen de la tabla
img_tabla_puntajes = pygame.image.load(
    r'pygames\tablero-puntaje\recursos\img\tabla_puntajes.png')
pos_img_tabla_puntajes = (
    (ANCHO_VENTANA - img_tabla_puntajes.get_width()) // 2, 10)

# Creamos el texto del titulo
font_titulo = pygame.font.Font(
    r'pygames\tablero-puntaje\recursos\fonts\Halimount.otf', 50)
...
font_boton = pygame.font.Font(
    r'pygames\tablero-puntaje\recursos\fonts\Halimount.otf', 30)
...
font_tabla = pygame.font.Font(
    r'pygames\tablero-puntaje\recursos\fonts\Halimount.otf', 35)
lista_puntaje_txt = []
...
for item in lista_puntajes:
    ...
    nombre_txt = font_tabla.render(formatear_nombre_jugador(
        str(item["nombre"])), True, color_txt)
    puntaje_txt = font_tabla.render(formatear_puntaje(
        str(item["puntaje"])), True, color_txt)
